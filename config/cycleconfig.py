...
train_params = Map(
    {
        "modelA2B_load_path": Str(),
        "modelB2A_load_path": Str(),
        "modelA2B_save_path": Str(),
        "modelB2A_save_path": Str(),
...
schema_v4 = Map(
    {
        ...
        "dataset_paramsA": dataset_params,
        "train_data_loaderA": train_data_loaderA,
        "train_data_loaderB": train_data_loaderB,
